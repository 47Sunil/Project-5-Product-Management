...
const { registerUser, userLogin, getUser, updateUserDetails } = require('../controllers/userController')
const { createProduct, updateProductDetails, getProduct, getProductsById, deleteProductById } = require("../controllers/productController")
